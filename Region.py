...
class Region(object):
    ...
    def can_fill(self, item, manual=False):
        ...
        if item.map or item.compass:
            is_self_dungeon_restricted = item.world.shuffle_mapcompass in ['dungeon', 'vanilla'] #We want to check if the actuall ITEM can be placed somewhere else.
            is_dungeon_restricted = item.world.shuffle_mapcompass == 'any_dungeon'
            is_overworld_restricted = item.world.shuffle_mapcompass == 'overworld'
        elif item.type == 'SmallKey':
            is_self_dungeon_restricted = item.world.shuffle_smallkeys in ['dungeon', 'vanilla']
            is_dungeon_restricted = item.world.shuffle_smallkeys == 'any_dungeon'
            is_overworld_restricted = item.world.shuffle_smallkeys == 'overworld'
        elif item.type == 'FortressSmallKey':
            is_dungeon_restricted = item.world.shuffle_fortresskeys == 'any_dungeon'
            is_overworld_restricted = item.world.shuffle_fortresskeys == 'overworld'
        elif item.type == 'BossKey':
            is_self_dungeon_restricted = item.world.shuffle_bosskeys in ['dungeon', 'vanilla']
            is_dungeon_restricted = item.world.shuffle_bosskeys == 'any_dungeon'
            is_overworld_restricted = item.world.shuffle_bosskeys == 'overworld'
        elif item.type == 'GanonBossKey':
            is_self_dungeon_restricted = item.world.shuffle_ganon_bosskey in ['dungeon', 'vanilla']
            is_dungeon_restricted = item.world.shuffle_ganon_bosskey == 'any_dungeon'
            is_overworld_restricted = item.world.shuffle_ganon_bosskey == 'overworld'
